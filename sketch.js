...
var superman, supermanImg, rope
var backgroungImg, monster, monsterImg

function preload(){
  backgroundImg=loadImage("sprites/bkimg.png");
...
function setup() {
  ...
  rope = new Rope(superman.body, { x: 200, y: 200 });
...
function keyPressed(){
  if(keyCode === 32){
      Matter.Body.setPosition(superman.body, {x: 200 , y: 200});
